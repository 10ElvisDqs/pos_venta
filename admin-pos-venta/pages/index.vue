     ...
     <div slot="body">
       <div class="row">
           <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
             <div class="card" style="background: linear-gradient(90deg, orange, white);">
                   ...
                   <div class="col-4 text-end">
                     <div
                       class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md"
                        style="background: linear-gradient(90deg, orange, darkorange);"
                     >
                       <i
                         class="fa fa-tag text-lg opacity-10"
                         aria-hidden="true"
                       ></i>
                     </div>
                   </div>
                 ...
                 <div class="row">
                   <div class="col-lg-6">
                     <div class="d-flex flex-column h-50">
                       <p class="mb-1 pt-2 text-bold">STHIL</p>
                       <h5 class="font-weight-bolder">Tu herramienta ideal</h5>
                       <p class="">
                        Produce la marca número uno en ventas de motosierras y una línea completa de herramientas eléctricas para exteriores, desde sopladores, podadoras, desbrozadoras hasta herramientas de construcción.
                      </p>
                       <a
           ...
           <div class="col-lg-5">
             <div class="card h-100 p-3">
               <div
                 ...
                 style="background-image: url('/assets/img/d1.jpg')"
               >
                 <span class="mask bg-gradient-orange"></span>
                 <div
