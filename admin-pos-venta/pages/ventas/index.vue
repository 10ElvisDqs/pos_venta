  ...
  <div class="w-100">
    <div class="row">
      <div class="col-6 text-start">
        ...
        <select v-model="impresion" id="impresion" class="form-control">
      ...
      <div v-if="impresion == 2" class="col-6 text-start">
        ...
        <select v-model="impreso_tipo" id="impreso_tipo" class="form-control">
    ...
    <div class="form-group">
                      ...
                      <select v-model="clienteSeleccionado" id="clienteSelect" class="form-control">
                          <option v-for="cliente in clientes" :key="cliente.id" :value="cliente.nombre" :ref="cliente.paterno">
...
export default {
  ...
  methods: {
    ...
    async Datos() {
      try {
        await Promise.all([this.GET_DATA('marcas'),this.GET_DATA('categorias'),this.GET_DATA('inventarios'),this.GET_DATA('sucursals'),this.GET_DATA('clientes')]).then((v) => {
          this.marcas = v[0];
          this.categorias = v[1];
          this.articulos = v[2];
          this.sucursals = v[3];
